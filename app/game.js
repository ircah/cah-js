...
function stop_game(gameid, user) {
	...
	global.client.devoice(games[gameid].settings.channel, games[gameid].players);
...
function join_game(gameid, user)
{
	...
	global.client.voice(games[gameid].settings.channel, user);
...
function leave_game(gameid, user)
{
	if(_.indexOf(games[gameid].players, user) == -1)
		return;
	global.client.devoice(games[gameid].settings.channel, user);
